...
const getWasteDetails = async (req, res, next) => {
    try {
        ...
        const wasteReport = await WasteReport.findById(wasteId)
            ...
            .populate('assignedBin', 'binId location fillLevel wasteType currentWasteComposition') 
            .lean();
        ...
        const responseData = {
            ...
            currentProcessingRequest: processingRequestDetails,
        };
